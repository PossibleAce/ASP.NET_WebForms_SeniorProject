    ...
    public partial class Hold : System.Web.UI.Page
    {
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string connectionString = ConfigurationManager.ConnectionStrings["ApplicationServices"].ConnectionString;
                string insertSql = "INSERT INTO Request (RequestID, eNumber, RequestType, ItemNumber, FirstName, LastName, Email, PhoneNumber, Department) VALUES(@ID, @EN, @RT, @IN, @FN, @LN, @Email, @PN, @DPT)";
                ...
                using (SqlConnection myConnection = new SqlConnection(connectionString))
                {
                    ...
                    myCommand.Parameters.AddWithValue("@RT", "Hold");
