...
CREATE TABLE [dbo].[Reserve](
	[atsPersonnel] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[itemNumber] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[eNumber] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
CREATE TABLE [dbo].[Request](
	[RequestID] [nchar](32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[eNumber] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[RequestType] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[StartDate] [date] NULL,
	[EndDate] [date] NULL,
	[ItemNumber] [nchar](32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[FirstName] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[LastName] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[Email] [nchar](32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[PhoneNumber] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[Department] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[Done] [bit] NULL,
	[ProcessPersonnel] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ProcessedTime] [nchar](32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
CREATE TABLE [dbo].[Faculty](
	[eNumber] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[firstName] [nchar](32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[lastName] [nchar](32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[phoneNumber] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[email] [nchar](32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[department] [nchar](32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
CREATE TABLE [dbo].[EquipmentItem](
	...
	[categoryID] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[keywords] [nchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[entryDate] [date] NULL,
...
CREATE TABLE [dbo].[CheckOut](
	...
	[eNumber] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[itemNumber] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[personnelCheckedIn] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[personnelCheckedOut] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[checkOutDate] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[dateReturned] [nchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
CREATE TABLE [dbo].[category](
	...
	[categoryname] [nchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
CREATE TABLE [dbo].[UserInfo](
	...
	[ATSID] [nvarchar](256) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[UserName] [nvarchar](256) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[PhoneNumber] [nvarchar](256) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
ALTER TABLE [dbo].[Request] ADD  CONSTRAINT [DF_Request_Done]  DEFAULT ((0)) FOR [Done]
GO
ALTER TABLE [dbo].[Hold] ADD  CONSTRAINT [DF_Hold_startReserveDate]  DEFAULT (NULL) FOR [startReserveDate]
GO
ALTER TABLE [dbo].[Hold] ADD  CONSTRAINT [DF_Hold_endReserveDate]  DEFAULT (NULL) FOR [endReserveDate]
GO
ALTER TABLE [dbo].[EquipmentItem] ADD  CONSTRAINT [DF_EquipmentItem_checkedOut]  DEFAULT ((0)) FOR [checkedOut]
GO
...
REFERENCES [dbo].[aspnet_Users] ([UserId])
GO
ALTER TABLE [dbo].[UserInfo]  WITH CHECK ADD  CONSTRAINT [FK_UserInfo_aspnet_Users] FOREIGN KEY([UserId])
REFERENCES [dbo].[aspnet_Users] ([UserId])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[UserInfo] CHECK CONSTRAINT [FK_UserInfo_aspnet_Users]
GO
