    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style27">
                ...
                <asp:TextBoxWatermarkExtender ID="OldPW_TextBoxWatermarkExtender" 
                    runat="server" TargetControlID="OldPW" WatermarkText="Old Password">
                </asp:TextBoxWatermarkExtender>
            </td>
            <td class="style42">
    ...
    <span id="MainContent_Label13" 
        ...
        <tr>
            ...
            <td class="style28">
                ...
                <asp:TextBoxWatermarkExtender ID="NewPW_TextBoxWatermarkExtender" 
                    runat="server" TargetControlID="NewPW" WatermarkText="New Password">
                </asp:TextBoxWatermarkExtender>
            </td>
            <td class="style43">
    ...
    <span id="MainContent_Label15" 
        ...
        <tr>
            ...
            <td class="style28">
                ...
                <asp:TextBoxWatermarkExtender ID="ConfirmPW_TextBoxWatermarkExtender" 
                    runat="server" TargetControlID="ConfirmPW" WatermarkText="Confirm Password">
                </asp:TextBoxWatermarkExtender>
            </td>
            <td class="style43">
        ...
        <tr>
            <td class="style4">
                <asp:Button ID="Button5" runat="server" onclick="Button5_Click" 
                    Text="Change Password" Width="200px" CssClass="button" />
            </td>
            <td class="style24">
