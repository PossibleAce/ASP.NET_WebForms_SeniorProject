<%@ Page Title="Renew" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Renew.aspx.cs" Inherits="ATS.Request.Renew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="style1">
        <tr>
            <td class="style2">
                <asp:Label ID="Label10" runat="server" Text="Renew this item: "></asp:Label>
        ...
        <tr>
            ...
            <td class="style17">
                ...
                <asp:TextBoxWatermarkExtender ID="EN_TextBoxWatermarkExtender" runat="server" 
                    TargetControlID="EN" WatermarkText="E0000000">
        ...
        <tr>
            ...
            <td class="style17">
                ...
                <asp:TextBoxWatermarkExtender ID="FN_TextBoxWatermarkExtender" runat="server" 
                    TargetControlID="FN" WatermarkText="First">
                </asp:TextBoxWatermarkExtender>
            </td>
            <td class="style19">
                &nbsp;</td>
        ...
        <tr>
            ...
            <td class="style17">
                ...
                <asp:TextBoxWatermarkExtender ID="LN_TextBoxWatermarkExtender" runat="server" 
                    TargetControlID="LN" WatermarkText="Last">
                </asp:TextBoxWatermarkExtender>
            </td>
            <td class="style19">
                &nbsp;</td>
        ...
        <tr>
            ...
            <td class="style17">
                ...
                <asp:TextBoxWatermarkExtender ID="PN_TextBoxWatermarkExtender" runat="server" 
                    TargetControlID="PN" WatermarkText="(555)555-5555">
                </asp:TextBoxWatermarkExtender>
            </td>
            <td class="style19">
                &nbsp;</td>
        ...
        <tr>
            <td class="style21" colspan="4">
                Renewing an item will extend another check out length for the current user.</td>
        </tr>
        <tr>
            <td class="style2">
                <asp:Button ID="Button1" runat="server" Text="Submit" 
                    onclick="Button1_Click1" CssClass="button" />
            </td>
            <td class="style17">
