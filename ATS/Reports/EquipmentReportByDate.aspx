...
<br />
                ...
                <asp:TextBoxWatermarkExtender ID="Date1TextBox_TextBoxWatermarkExtender" 
                    runat="server" TargetControlID="Date1TextBox" WatermarkText="MM/DD/YYYY">
                </asp:TextBoxWatermarkExtender>
                <asp:Label ID="Label2" runat="server" Text="and"></asp:Label>
                <asp:TextBox ID="Date2TextBox"
                    runat="server"></asp:TextBox>
                    <asp:TextBoxWatermarkExtender ID="Date2TextBox_TextBoxWatermarkExtender" 
                    runat="server" TargetControlID="Date2TextBox" WatermarkText="MM/DD/YYYY">
                </asp:TextBoxWatermarkExtender>
