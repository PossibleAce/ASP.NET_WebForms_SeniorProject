    ...
    <h2>
        Inventory Management: Select an Option to Modify Equipment Inventory
            ...
            <asp:Button ID="Button4" runat="server" onclick="Button4_Click" 
                Text="Add Equpment" Width="206px" CssClass="button" />
            <asp:Button ID="Button2" runat="server" onclick="Button2_Click" 
                Text="Add Category" Width="206px" CssClass="button" />
            <asp:Button ID="Button3" runat="server" onclick="Button3_Click" 
                Text="Delete Equipment" style="margin-bottom: 0px" 
            Width="206px" CssClass="button" />
                </p>
                <p>
                <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                        Text="Modify Equipment" Width="206px" CssClass="button" />
                    <asp:Button ID="Button5" runat="server" onclick="Button5_Click" 
                        Text="Modify Category" Width="206px" CssClass="button" />
