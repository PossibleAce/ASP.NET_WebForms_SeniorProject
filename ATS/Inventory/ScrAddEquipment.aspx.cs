        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            entryDate = entryDate.ToLocalTime();
                ...
                if (!dr.HasRows && test == false)
                {
                    ...
                    string sql = "INSERT INTO EquipmentItem(itemNumber,name,serialNumber,dollarValue,categoryID,keywords,entryDate,checkOutLength,comments,lost,damaged,stolen,visible,sentToSurplus) VALUES ('" +
                        itemNumber + "', '" + name + "', '" + serialNumber + "', '" + dollarvalue + "', '" +
                        category + "', '" + keywords + "','" +
                        entryDate + "', '" + checkOutLength + "', '" + comments + "',  '" + lost + "', '" + damaged + "', '" + stolen + "', '" + visible + "', '" + sentToSurplus + "')";
                        dr.Close();
