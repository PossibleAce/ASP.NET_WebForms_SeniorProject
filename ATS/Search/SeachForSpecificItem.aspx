...
<h2> Search For Specific Equipment Item</h2>
    <p> 
        ...
        &nbsp;&nbsp;&nbsp;
            <asp:RequiredFieldValidator ID="ItemValidator" runat="server" 
                ControlToValidate="SearchTextBox" ErrorMessage="Enter an Item to Search for"></asp:RequiredFieldValidator>
        <br />
 ...
 <asp:TextBox ID="CheckOutTextBox" runat="server" ReadOnly="True" 
        ...
        <asp:Button ID="ClearButton" runat="server" Text="Clear" 
            CssClass="button" onclick="ClearButton_Click" Width="110px" />
        <br />
    </p>
</asp:Content>